...
<head>
  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">  <link rel="stylesheet" href="./assets/css/style.css">
...
<body id="top">
  <header class="header" data-header>
    <div class="container">
      ...
      <a href="http://localhost/projectweb" class="logo">
        <h2>webNestle</h2>
      </a>
      ...
      <nav class="navbar">
        <div class="container">
          <ul class="navbar-list">
            ...
            <li>
              <a href="http://localhost/projectweb" class="navbar-link" data-navbar-link>Home</a>
            </li>
  ...
  <div class="hero-section" style="margin-top: 150px;" >
  <div class="container">
            ...
            <form action="connect.php" method="post">
              ...
              <div class="mb-3">
                ...
                <div>
                  ...
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="gender" id="others" value="o" required>
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>  <script src="./assets/js/script.js"></script>
